...
const PIPE_ENRICHMENT = {
  ...
  "f5-6": {
    ...
    concepts: [
      { term: "/eda", def: "Vista interactiva principal con ≥4 gráficas y controles." },
    ...
    process: ["Publicar URL en informe IEEE.", "Grabar video recorriendo /eda.", "Incluir enlace en README del repo."],
  },
};
...
const PIPE_PHASES = {
  ...
  3: {
    ...
    steps: [
      ...
      { id: "f3-6", type: "output", icon: "file", tag: "Salida", title: "Figuras", stat: "P1 · P2", detail: { title: "Artefactos EDA exportados", summary: "Figuras estáticas + JSON que alimentan prepare_dashboard.py.", bullets: ["outputs/chembl/figures/*.png", "Hallazgos narrados en informe IEEE.", "correlation_pearson.json → dashboard /eda."], visual: "charts", artifact: "outputs/chembl/figures/", code: [{ title: "Preparar dashboard", lang: "bash", code: "python scripts/fase5/prepare_dashboard.py" }] } },
    ],
  },
  4: {
    overview: {
  ...
  5: {
    ...
    steps: [
      ...
      { id: "f5-6", type: "output", icon: "globe", tag: "Live", title: "URLs", stat: "/eda", detail: { title: "Dashboard público en producción", summary: "URLs para evaluación del curso y video explicativo del proyecto.", bullets: ["/eda — exploración interactiva.", "/presentacion — slides del pipeline.", "Enlace en informe IEEE y README."], visual: "deploy", artifact: "/health", code: [{ title: "Healthcheck", lang: "bash", code: "curl https://tu-app.onrender.com/health\n# → {\"status\": \"ok\"}" }] } },
    ],
  },
};
